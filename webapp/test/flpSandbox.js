		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App OV",
									"targetURL": "#ordemdevendasproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordemdevendasproject1-display": {
								"semanticObject": "ordemdevendasproject1",
								"action": "display",
								"description": "App OV",
								"title": "App OV",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordemdevendas.project1",
									"url": sap.ui.require.toUrl("ordemdevendas/project1")
								}
							}
						}
					}
